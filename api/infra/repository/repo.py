...
class Repository(IRepository):
    def daily(
        ...
        # print(str(res))
        return "자바에서 new와 this 키워드는 각각 어떤 역할을 하는지 설명하라. new 키워드를 사용해 객체를 생성하는 과정과, this 키워드가 메서드와 생성자에서 어떻게 쓰이는지 구체적인 예를 들어 설명하라."
